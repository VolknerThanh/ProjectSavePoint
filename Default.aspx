                ...
                <AlternatingItemTemplate>
                    <td runat="server" style="padding:20px;">
                        <div style=" background-color:white; box-shadow: 2px 2px 10px; margin: 20px 20px 5px;padding: 20px 20px 10px; position:relative;">
                            ...
                            <br />
                            <%# (int)Eval("shoesStatus") == 1 ? "<div class='labelStatus'>NEW</div>" : "" %>

                            <div style="text-align:center;">
                                <asp:Button ID="Button1" CssClass="btn btn-1" runat="server" Text="View Detail" PostBackUrl='<%# Eval("id", "payment.aspx?ID={0}") %>' />
                            </div>
                        </div>
                    </td>
                </AlternatingItemTemplate>
...
<td runat="server" />
                ...
                <LayoutTemplate>
                    <table runat="server">
                        ...
                        <tr runat="server">
                            <td runat="server" style="position:relative; left: 45%; padding:20px;">
            ...
            <%
                if (title == "hunter")
                {
                    ...
                    Response.Write("<a class='btn btn-1' href="+"Default.aspx?tag=hunter-male"+">For Man</a>");
                    Response.Write("<a class='btn btn-1' href="+"Default.aspx?tag=hunter-female"+">For Woman</a>");
                    Response.Write("</div>");
                }
